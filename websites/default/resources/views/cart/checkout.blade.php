        ...
        <div class="row">
            <div class="col-md-4 order-md-2 mb-4">
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge badge-secondary badge-pill">{{$cartContent['totalQuantity']}}</span>
                </h4>
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form method="POST" class="needs-validation" action="{{url('/cart/checkout/complete')}}" novalidate>
                        {{csrf_field()}}
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="adresss2" type="text" class="form-control" id="address2" placeholder="Apartment or suite">
                    </div>
