...
<hr> @foreach($archivedCars as $car)
<div class="row">
    <div class="col-auto col-md-3 mr-auto">
        <button type="button" class="btn btn-warning btn-block" data-toggle="modal" data-target="#CAR{{$car->id}}"><i class="fas fa-car"></i> {{$car->name}}</button>
    </div>
    <div class="col-auto">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                    <form method="POST" action="/cms/car/unarchive/{{$car->id}}">
