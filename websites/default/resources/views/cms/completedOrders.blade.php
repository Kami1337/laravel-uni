<div class="row">
        ...
        <hr>
        <div class="col-auto">
            <span class="badge badge-pill badge-success"><h4>{{$completedTotal}}</h4></span>
        </div>
    </div>
    <hr> @foreach($completedOrders as $order)
    
    <div class="row">
        <div class="col-auto col-md-3 mr-auto">
            <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#ORD{{$order->id}}"><i class="fas fa-people-carry"></i> <?php echo $order->cartData($order->id,'name')?></button>
